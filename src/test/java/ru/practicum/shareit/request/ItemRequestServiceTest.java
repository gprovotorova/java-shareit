...
public class ItemRequestServiceTest {
    ...
    void getRequestsByOwner_shouldThrowExceptionIfUserIdIsIncorrect() {
        assertThrows(ObjectNotFoundException.class,
                () -> itemRequestService.getRequestsByOwner(100L));
    }
    ...
    void getAllRequests_shouldReturnExistingRequests() {
        ...
        List<ItemRequestDto> savedRequestDtos = itemRequestService.getAllRequests(1L, FROM, SIZE);
    ...
    void getAllRequests_shouldThrowExceptionIfUserIdIsIncorrect() {
        assertThrows(ObjectNotFoundException.class,
                () -> itemRequestService.getAllRequests(100L, FROM, SIZE));
    }
    ...
    void getAllRequests_shouldReturnAllRequestsIfSizeIsNull() {
        ...
        List<ItemRequestDto> savedRequestDtos = itemRequestService.getAllRequests(1L, FROM, null);
